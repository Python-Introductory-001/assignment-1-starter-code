...
# The goal of this assignment is to undertand the structure of a basic Python program. 
# We will create a simple program that returns the string "Hello, World!".
